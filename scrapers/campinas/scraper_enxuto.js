  ...
  try {
    for (const [index, linha] of linhasProdutos.entries()) {
      ...
      for (const termoOriginal of termosParaTentar) {
        ...
        try {
          await page.goto(
            `https://www.enxuto.com.br/busca?q=${encodeURIComponent(termoParaBusca)}`,
        ...
        if (filtrados.length > 0) {
          ...
          resultado.push({ id, supermercado: "Enxuto", produto: maisBarato.nome, preco: maisBarato.preco, preco_por_kg: maisBarato.preco_por_kg });
