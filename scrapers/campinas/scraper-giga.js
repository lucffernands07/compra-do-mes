  ...
  try {
    for (const [index, linha] of linhasProdutos.entries()) {
      ...
      for (const termoOriginal of termosParaTentar) {
        ...
        try {
          await page.goto(
            `https://www.giga.com.br/busca?termo=${encodeURIComponent(termoParaBusca)}`,
        ...
        if (filtrados.length > 0) {
          ...
          resultado.push({ id, supermercado: "Giga Atacado", produto: maisBarato.nome, preco: maisBarato.preco, preco_por_kg: maisBarato.preco_por_kg });
